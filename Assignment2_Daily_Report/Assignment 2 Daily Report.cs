...
namespace Assignment2_Daily_Report
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int pageNum = Convert.ToInt16(pageNumber); //would ushort be better here, bc page number won't go over 65,000.  However, don't know how to convert string to ushort and a Google search makes it seem quite complicated.
